    ...
    <script type="application/ld+json">
      {JSON.stringify({
        ...
        publisher: {
          ...
          name: 'CookieBot.ai',
          url: 'https://cookiebot.ai',
          logo: { '@type': 'ImageObject', url: 'https://cookiebot.ai/logo.png' }
        }
      })}
    </script>
  </Helmet>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              {isAuthenticated() ? (
                ...
                <>
                  <Button variant="outline" size="sm" onClick={handleAuthClick}>Sign In</Button>
                  <Button
                    size="sm"
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <div className="max-w-4xl mx-auto">
            <Badge className="mb-6 bg-white/20 text-white border-white/30">🤖 Your AI-Powered Cookie Consent Robot</Badge>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              Cookie Consent
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> That Pays</span>
            </h1>
  ...
  const features = [
    {
      ...
      description:
        'Complete control over banner appearance with Dialog and Bar layouts, positioning options, visual effects, and responsive design.',
    ...
    },
    {
      ...
      description:
        'Light, Dark, and Custom themes with complete color control, button style variations, and company branding integration.',
    ...
    },
    {
      ...
      description:
        'Unique monetization through educational privacy content. Earn 60% revenue share from every consent interaction with real-time tracking.',
    ...
    },
    {
      ...
      description:
        'Built-in support for GDPR, CCPA, and LGPD with automatic jurisdiction detection, granular consent controls, and legal record keeping.',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            CookieBot.ai goes beyond traditional consent management with AI-powered features that help you comply, customize, and monetize like never before.
          </p>
        </div>
    ...
    <section id="customization" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Unmatched
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Customization</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            CookieBot.ai offers the most comprehensive customization options in the industry. Match your brand perfectly with our advanced theming and layout system.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            See your customizations in real-time with our live preview system. Test different themes, layouts, and configurations instantly before deploying to your website.
          </p>
          <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
            Try Live Preview
...
const DashboardSection = () => {
  const dashboardFeatures = [
    { icon: <BarChart3 className="h-6 w-6" />, title: 'Real-time Analytics', description: 'Monitor consent rates, visitor tracking, and performance metrics in real-time.' },
    { icon: <DollarSign className="h-6 w-6" />, title: 'Revenue Tracking', description: 'Track Privacy Insights revenue, performance metrics, and automated payout processing.' },
    { icon: <Shield className="h-6 w-6" />, title: 'Compliance Monitoring', description: 'Monitor compliance status, consent records, and legal requirement adherence.' },
    { icon: <Layout className="h-6 w-6" />, title: 'Configuration Management', description: 'Manage customization options through an intuitive interface.' },
    { icon: <Sliders className="h-6 w-6" />, title: 'Advanced Customization', description: 'Fine-tune every aspect of your consent banner experience.' },
    { icon: <Eye className="h-6 w-6" />, title: 'Live Preview', description: 'Preview banner changes in real-time with responsive design testing.' }
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Monitor your consent performance, track Privacy Insights revenue, and optimize your setup with our comprehensive analytics dashboard.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
              <img
                ...
                alt="CookieBot.ai AI-Powered Dashboard"
    ...
    <section id="pricing" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Start free and scale as you grow. All plans include our AI-powered customization features and GDPR compliance. Professional plans include Privacy Insights revenue sharing.
          </p>
        </div>
  ...
  const testimonials = [
    {
      ...
      company: 'TechCorp',
      content:
        'CookieBot.ai has transformed our compliance strategy. The Privacy Insights revenue feature actually makes our cookie consent profitable!',
      rating: 5
    },
    {
      name: 'Michael Chen',
      ...
      content:
        "The AI-powered customization options are incredible. We can match any client's brand perfectly with the advanced theming system.",
      rating: 5
    },
    {
      name: 'Emma Rodriguez',
      ...
      content:
        'Finally, a solution that handles GDPR, CCPA, and LGPD automatically. The AI optimization makes compliance monitoring effortless.',
      rating: 5
    }
  ]
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of businesses who trust CookieBot.ai for their AI-powered cookie consent management and Privacy Insights revenue generation.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto text-white">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Join thousands of websites already earning revenue with CookieBot.ai. Start your free trial today and see the difference AI-powered customization makes.
            </p>
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about CookieBot.ai? Our team is here to help you get started with AI-powered cookie consent management and Privacy Insights revenue generation.
          </p>
        </div>
  ...
  <footer className="bg-gray-900 text-white py-16">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          ...
          <p className="text-gray-400 mb-4">
            The most advanced AI-powered cookie consent platform with built-in Privacy Insights revenue generation and comprehensive customization options.
          </p>
          <div className="flex space-x-4">
      ...
      <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
        <p>&copy; {new Date().getFullYear()} CookieBot.ai. All rights reserved.</p>
      </div>
    </div>
  </footer>
)
...
/* ------------ App Shell ------------ */
const AppContent = () => {
  const [showDemo, setShowDemo] = useState(false) // reserved for potential demo modal
  return (
