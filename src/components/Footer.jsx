...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Email', icon: Mail, href: 'mailto:hello@cookiebot.ai' }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              The AI-powered cookie consent platform that pays you while ensuring complete GDPR, CCPA, and LGPD compliance.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} CookieBot.ai. All rights reserved.
            </div>
